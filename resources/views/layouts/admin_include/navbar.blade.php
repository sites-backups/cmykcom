        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo"
                            ...
                            src="{{ asset('public/admin_asset') }}/app-assets/images/logo/stack-logo-light.png">
                        <h2 class="brand-text">BCB</h2>
                    </a></li>
                <li class="nav-item d-none d-lg-block nav-toggle"><a class="nav-link modern-nav-toggle pr-0"
                        data-toggle="collapse"><i class="fa fa-toggle-on font-medium-3 white"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav ">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label"
                            href="#" data-toggle="dropdown"><i class="fa fa-bell"></i><span
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label"
                            href="#" data-toggle="dropdown"><i class="fa fa-envelope-o"></i><span
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="avatar avatar-online"><img
                                    src="{{ asset('public/admin_asset') }}/app-assets/images/portrait/small/avatar-s-1.png"
